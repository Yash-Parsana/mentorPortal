...
export default function BecomeMenter() {
  ...
  const uploadProfile = (e) => {
    ...
    console.log('userinpage', user);
    console.log('all fields of profile', inputTag.intro, inputTag.district, inputTag.state, inputTag.industry, inputTag.photoLink, tagList, tagList2, tagList3);
  }
  ...
  const setToTaglist2 = (e, k) => {
    if (e.keyCode == 13) {
      setTaglist2([...tagList2, k]);
      e.target.value = "";
    }
  };
  const setToTaglist3 = (e, k) => {
    if (e.keyCode == 13) {
      setTaglist3([...tagList3, k]);
      e.target.value = "";
    }
  };
          ...
          <form onSubmit={uploadProfile} >
            ...
            <div className="justify-content align-center  mt-3 ">
              <div className="w-25" style={{ textAlign: 'left' }}>
                <button type="submit" style={{ height: "41px", boxShadow: "2px -1px 32px 0px rgba(44,94,255,0.36)" }}
